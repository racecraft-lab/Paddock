...
## Recent Changes
- Archive extension run (2026-05-22): `.specify/memory/{spec,plan,changelog}.md` now carries recovery/provenance summaries through SPEC-013A, including SPEC-009C3, SPEC-009C4, SPEC-009D, SPEC-009E, SPEC-009F, SPEC-010A, SPEC-012A, and SPEC-013A. Cleanup was not applied because `--apply-cleanup` was not requested and unrelated untracked `.agents/.codex` files keep the worktree dirty for cleanup gates.
