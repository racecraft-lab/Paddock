...
- **Current active setup:** No SPEC-010B, SPEC-013C, SPEC-013D, SPEC-014A, SPEC-014B, or SPEC-014C implementation workflow remains active after PR #83/#63/#65/#64/#76/#79 merge and recorded post-implementation evidence. SPEC-012B is now unblocked by real two-product-line behavior; SPEC-014D/E/F and SPEC-015A are pending follow-ons. SPEC-015A is the recorded IA/UI follow-up from SPEC-014C HAL browser UAT because workflow contracts/templates/pipelines need a first-class operator page instead of being stacked above Agent Squad on `/agents`. SPEC-011 remains a parallel option when file ownership stays disjoint because it touches the optional security adapter.
...
- **Scale/doc parallel path:** SPEC-010A is complete after post-merge UAT; SPEC-010B is complete after PR #83 merge and HAL Product Line B smoke evidence; SPEC-012B can proceed with real two-product-line behavior.
...
- SPEC-012B is unblocked by SPEC-010B and should encode real two-product-line behavior.
