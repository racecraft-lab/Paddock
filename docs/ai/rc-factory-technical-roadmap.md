...
- **Control-plane path:** SPEC-013A, SPEC-013A1, SPEC-013B, and SPEC-013C are complete after post-merge UAT. SPEC-013D owns the minimal operator UX needed to make claim controls usable before first real harness operation. SPEC-014A-D own execution inside already-claimed work. These completed specs do not launch harnesses.
...
- SPEC-009F, SPEC-013A, SPEC-013A1, SPEC-013B, SPEC-013C, and SPEC-014A are complete after their recorded merge and UAT gates; SPEC-013D is required after SPEC-013C to close the operator UX gap before SPEC-014C, and SPEC-014B is now unblocked after SPEC-014A.
