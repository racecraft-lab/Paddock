...
- **Next setup:** SPEC-013B, SPEC-013C, SPEC-013D, SPEC-014A, SPEC-014B, SPEC-014C, and SPEC-010B are complete after merge and recorded UAT evidence. SPEC-012B, SPEC-014D, SPEC-014E, SPEC-014F, and SPEC-015A are available follow-on lanes when file ownership stays disjoint. SPEC-011 remains an optional parallel start when the security adapter scope stays isolated.
...
- SPEC-010A is complete after PR #59 and 2026-05-22 post-merge UAT; SPEC-010B is complete after PR #83 and HAL Product Line B smoke evidence; SPEC-011 may also start when file ownership stays disjoint.
