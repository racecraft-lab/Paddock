...
- Paddock was deployed on the operator node from `main`; `paddock.service` and `openclaw-gateway.service` were active and `/login` returned HTTP 200 after deployment verification.
