...
- **Seed script**: `scripts/seed-focusengine-workspace.ts`:
  ...
  - Set `FocusEngine workspace.github_repo = 'visual-reviewer/focusengine'` (or canonical repo).
