...
As of 2026-05-01, SPEC-004 is merged on PR #22 as `20643d8` and SPEC-006 is merged on PR #21 as `dbb6c75`. SPEC-005 is the active next runtime spec for the `ready_for_owner` two-step terminal gate.
