...
- Repository/release metadata now consistently points at `racecraft-lab/Paddock`
...
- Stopped forcing `dangerouslyDisableDeviceAuth` when registering Paddock as a dashboard
