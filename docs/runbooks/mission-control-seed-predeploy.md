...
3. Remove only non-Mission-Control residue. Keep `racecraft-lab/Paddock` issue sync metadata intact because SPEC-009B re-homes it to QA triage/intake.
