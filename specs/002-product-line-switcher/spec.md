...
- **SC-018**: Argos Playwright and Storybook visual evidence includes screenshot metadata with test/story identity, source location, and SPEC-002 tags; non-visual flag-OFF regression runs do not upload empty Argos builds.
