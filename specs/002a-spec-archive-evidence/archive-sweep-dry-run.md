...
- Argos summary: `https://app.argos-ci.com/visual-reviewer/mission-control`
...
| `argos/spec-002-storybook` | success | `https://app.argos-ci.com/visual-reviewer/mission-control/builds/11` |
| `argos/spec-002-playwright` | success | `https://app.argos-ci.com/visual-reviewer/mission-control/builds/12` |
| `argos/summary` | success | `https://app.argos-ci.com/visual-reviewer/mission-control` |
