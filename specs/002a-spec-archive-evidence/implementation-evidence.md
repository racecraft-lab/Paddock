...
```text
$ git worktree list
/Users/fredrickgabelmann/Documents/Business_Documents/RSE_Documents/Projects/racecraft-mission-control                                        c15a48e [feat/openfeature-feature-flags]
/Users/fredrickgabelmann/Documents/Business_Documents/RSE_Documents/Projects/racecraft-mission-control/.worktrees/001-foundation-migrations   f100cc4 [001-foundation-migrations]
/Users/fredrickgabelmann/Documents/Business_Documents/RSE_Documents/Projects/racecraft-mission-control/.worktrees/002-product-line-switcher   7e5f6e1 [002-product-line-switcher]
/Users/fredrickgabelmann/Documents/Business_Documents/RSE_Documents/Projects/racecraft-mission-control/.worktrees/002a-spec-archive-evidence  c908bf8 [002a-spec-archive-evidence]
```
...
`/Users/fredrickgabelmann/.agents/plugins/marketplace.json` remains valid JSON and already points `speckit-pro` at the intended local source path:
...
The path resolves to `/Users/fredrickgabelmann/.codex/plugins/speckit-pro`, so no marketplace edit was required.
...
```text
$ diff -qr /Users/fredrickgabelmann/.codex/plugins/speckit-pro/codex-agents /tmp/racecraft-plugins-public.8f1rVV/repo/speckit-pro/codex-agents
$ diff -qr /Users/fredrickgabelmann/.codex/agents /Users/fredrickgabelmann/.codex/plugins/speckit-pro/codex-agents
```
...
```text
$ cat /Users/fredrickgabelmann/.codex/plugins/speckit-pro/.codex-plugin/plugin.json
$ cat /Users/fredrickgabelmann/.codex/plugins/cache/racecraft-plugins-public/speckit-pro/1.9.0/.codex-plugin/plugin.json
$ python3 -m json.tool /Users/fredrickgabelmann/.agents/plugins/marketplace.json
$ python3 -c "import json, pathlib; data=json.load(open('/Users/fredrickgabelmann/.agents/plugins/marketplace.json')); p=data['plugins'][0]['source']['path']; target=(pathlib.Path('/Users/fredrickgabelmann')/p).resolve(); print(data['plugins'][0]['name'], data['plugins'][0]['source']['source'], p, target, target.is_dir())"
$ rg -n "Archive Sweep|archive extension|speckit\\.archive|previously merged|safe cleanup" /Users/fredrickgabelmann/.codex/plugins/speckit-pro/codex-skills/speckit-autopilot/SKILL.md /Users/fredrickgabelmann/.codex/plugins/speckit-pro/codex-skills/speckit-coach/SKILL.md /Users/fredrickgabelmann/.codex/plugins/speckit-pro/codex-skills/speckit-status/SKILL.md
```
...
```text
$ bash /Users/fredrickgabelmann/.codex/plugins/speckit-pro/skills/speckit-autopilot/scripts/validate-gate.sh G7 specs/002a-spec-archive-evidence
{"gate":"G7","pass":true,"reason":"All 47 tasks complete","markers":0,"total":47,"done":47}

$ bash /Users/fredrickgabelmann/.codex/plugins/speckit-pro/skills/speckit-autopilot/scripts/count-markers.sh all specs/002a-spec-archive-evidence
...
```text
$ python3 -c "import json; print(json.load(open('/Users/fredrickgabelmann/.codex/plugins/speckit-pro/.codex-plugin/plugin.json'))['version'])"
1.9.0

$ python3 -c "import json, pathlib; data=json.load(open('/Users/fredrickgabelmann/.agents/plugins/marketplace.json')); p=data['plugins'][0]['source']['path']; target=(pathlib.Path('/Users/fredrickgabelmann')/p).resolve(); print(data['plugins'][0]['name'], data['plugins'][0]['source']['source'], p, target, target.is_dir())"
speckit-pro local ./.codex/plugins/speckit-pro /Users/fredrickgabelmann/.codex/plugins/speckit-pro True
```
