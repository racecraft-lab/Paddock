...
- [X] T066 [US6] Update `openapi.json` per FR-064 a–e. Run JSON-schema parse / OpenAPI validator step in `pnpm test:all`. Must pass T063. Maps to FR-064.
