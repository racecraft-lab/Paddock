...
- Cleanup evidence is redacted by default: identifiers, paths, counts, timestamps, booleans, and hashes are acceptable, but raw credentials, tokens, secrets, Authorization headers, and matched secret substrings are never emitted.
