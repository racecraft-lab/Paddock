...
**Reviewability Budget**: Primary surface scheduler/runtime; secondary surfaces API, schema/migration, UI, docs/process; projected reviewable LOC 700-1,200; projected production files 8-14; projected total files 14-22; budget result warning accepted with split override from spec
