...
- [ ] T042 [US4] Execute HAL UAT preflight for deployed commit, `paddock.service`, `openclaw-gateway.service`, real `codex app-server --listen stdio://` availability, and workspace-scoped feature flags; record descriptor-only results in `specs/014c-first-real-harness-adapter/uat-report.md`
